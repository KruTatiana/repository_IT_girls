const directorsList = document.querySelector('ol');
const bestMoovies = document.querySelector('.best_moovies')
...
const topFilmsList = dataArray.map(item => {
  return item.top_rated_film;
});

bestMoovies.textContent = topFilmsList.join(',');